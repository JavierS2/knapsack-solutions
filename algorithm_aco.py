...
num_ants = 20
num_iterations = 100
initial_pheromone = 0.6     # Menor feromona inicial → menos aleatoriedad
evaporation = 0.05          # Conserva mejor la feromona → se explotan soluciones
alpha = 0.9                 # Alto peso a la feromona → sigue caminos exitosos
beta = 0.3                  # Menor peso a la heurística → menos foco en el valor individual


#SEGUNDA CONFIGURACIÓN
#initial_pheromone = 0.8     # Máxima feromona inicial para permitir mucha elección al inicio
#evaporation = 0.3           # Se pierde feromona relativamente rápido
#alpha = 0.3                 # Bajo peso a la feromona → más aleatoriedad
#beta = 0.9                  # Alto peso a la heurística → busca cosas de mayor valor
...
def save_results_to_excel(best_value, elapsed_time, best_iteration, best_weight, best_solution):
    output_file = 'ACO_results_4kg.xlsx'
